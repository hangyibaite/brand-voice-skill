...
[name]-voice/
  ...
  references/
    ...
    anti-ai.md                      (always — copy verbatim from brand-voice/references/anti-ai.md)
...
Read `references/anti-ai.md`. Apply its bans to every output, no exceptions.
...
2. Copy `brand-voice/references/anti-ai.md` verbatim
